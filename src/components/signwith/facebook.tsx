...
const FacebookLoginButton: React.FC<FacebookLoginButtonProps> = ({
	...
	return (
		<div className="w-full">
			...
			></form>
			<a
				className={`text-black bg-white border-2 focus:outline-none font-medium rounded-lg text-sm px-5 py-2 text-center flex items-center dark:focus:ring-[#3b5998]/55  mb-2  mt-3   justify-center w-full ${
					loading ? 'opacity-20' : ''
				}`}
				href="#"
				onClick={handleLogin}
