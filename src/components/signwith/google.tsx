...
const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
	...
	return (
		<div className="w-full">
			...
			<a
				className={`text-black border-2 border-[#D7DFE9] bg-white focus:outline-none font-medium rounded-lg text-sm px-8 py-2 inline-flex dark:focus:ring-[#3b5998]/55 mr-5 mb-2 mt-3  w-full justify-center ${
					loading ? 'opacity-20' : ''
				}`}
				href="#"
				onClick={handleLogin}
