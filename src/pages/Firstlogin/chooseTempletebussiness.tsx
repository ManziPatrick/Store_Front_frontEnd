...
const ChooseTemplete: React.FC = () => {
	...
	return (
		<>
			<HeaderComponent
				backLink="/secondloginpagebussiness"
				skipLink="/managerdashboard"
				Width="3/4"
			/>
			<div className="flex flex-col font-inter gap-8 items-center justify-center max-w-full mx-auto md:px-5 w-full">
				<div className="flex flex-col gap-2 items-center justify-center w-auto md:w-full">
					<Text className="head text-center" size="txtInterSemiBold48">
						Choose a template to start
					</Text>
					<Text
						className="text-base text-blue_gray-800 text-center tracking-[-0.30px] w-auto"
				...
				<div className="grid md:grid-cols-4 w-4/5 grid-cols-1 md:gap-y-[] gap-y-[40px] sm:w-full">
					{templates.map((template, index) => (
						<div key={index}>
							<Img
								className="ml-3 md:ml-0 md:w-full w-[300px] h-[300px] shadow-[rgba(0,0,0,0.24)0px3px8px] object-cover"
